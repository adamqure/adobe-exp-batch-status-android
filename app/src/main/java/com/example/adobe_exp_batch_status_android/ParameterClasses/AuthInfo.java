package com.example.adobe_exp_batch_status_android.ParameterClasses;
...
public class AuthInfo {
    ...
    public void setImsOrg(String orgId) {
        this.imsOrgId = orgId;
    }

    public void setSubject(String techAccountId) {
        this.subject = techAccountId;
    }
